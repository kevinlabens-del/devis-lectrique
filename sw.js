const CACHE='devis-electrique-v13-1-categories';
...
self.addEventListener('fetch',event=>{
  ...
  if(req.mode==='navigate'||/\/(index\.html|app\.js|catalog-v13\.js|styles\.css|manifest\.webmanifest|sw\.js)$/.test(url.pathname)){
